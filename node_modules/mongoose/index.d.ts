declare module "mongoose" {
  ...
  interface Model<T, TQueryHelpers = {}, TMethods = {}, TVirtuals = {}>
    ...
    create(
      ...
      options?: SaveOptions
    ): Promise<EnforceDocument<T, TMethods, TVirtuals>[]>;
    create(
      docs: (AnyKeys<T> | AnyObject)[],
      callback: Callback<EnforceDocument<T, TMethods, TVirtuals>[]>
    ): void;
    create(
      doc: AnyKeys<T> | AnyObject
    ): Promise<EnforceDocument<T, TMethods, TVirtuals>>;
    ...
    findById(
      ...
      projection?: any | null,
      options?: QueryOptions | null,
      callback?: Callback<EnforceDocument<T, TMethods, TVirtuals> | null>
    ): QueryWithHelpers<
      EnforceDocument<T, TMethods, TVirtuals> | null,
      EnforceDocument<T, TMethods, TVirtuals>,
      TQueryHelpers,
      T
    >;
    ...
    ): Promise<Array<EnforceDocument<T, TMethods, TVirtuals>>>;
    insertMany(
      doc: AnyKeys<T> | AnyObject,
      options: InsertManyOptions & { rawResult: true }
    ): Promise<InsertManyResult>;
    ...
    insertMany(
      ...
      options?: InsertManyOptions,
      callback?: Callback<
        EnforceDocument<T, TMethods, TVirtuals>[] | InsertManyResult
      >
    ): void;
    insertMany(
      docs: Array<AnyKeys<T> | AnyObject>,
      options?: InsertManyOptions,
      callback?: Callback<
        Array<EnforceDocument<T, TMethods, TVirtuals>> | InsertManyResult
      >
    ): void;
    ...
    findByIdAndDelete(
      ...
      callback?: (
        err: CallbackError,
        doc: EnforceDocument<T, TMethods, TVirtuals> | null,
        res: any
      ) => void
    ): QueryWithHelpers<
      EnforceDocument<T, TMethods, TVirtuals> | null,
    ...
    findByIdAndUpdate(
      ...
      mongodb.ModifyResult<EnforceDocument<T, TMethods, TVirtuals>>,
      EnforceDocument<T, TMethods, TVirtuals>,
      TQueryHelpers,
      T
    >;
    findByIdAndUpdate(
      ...
      callback?: (
        err: CallbackError,
        doc: EnforceDocument<T, TMethods, TVirtuals>,
        res: any
      ) => void
    ): QueryWithHelpers<
      EnforceDocument<T, TMethods, TVirtuals>,
    ...
    geoSearch(
      ...
      callback?: Callback<Array<EnforceDocument<T, TMethods, TVirtuals>>>
    ): QueryWithHelpers<
      Array<EnforceDocument<T, TMethods, TVirtuals>>,
      EnforceDocument<T, TMethods, TVirtuals>,
      TQueryHelpers,
  ...
  > extends events.EventEmitter {
    ...
    method(
      name: string,
      fn: (
        this: EnforceDocument<DocType, TInstanceMethods, ExtractVirtuals<M>>,
        ...args: any[]
      ) => any,
      opts?: any
    ): this;
    ...
    post<T = EnforceDocument<DocType, TInstanceMethods, ExtractVirtuals<M>>>(
      method:
    ...
    pre<T = EnforceDocument<DocType, TInstanceMethods, ExtractVirtuals<M>>>(
      method: "save",
  ...
  type ApplyBasicQueryCasting<T> = T extends mongodb.ObjectId
    ? T | string // Allow strings for ObjectIds
    : T extends string
    ? T | RegExp // Allow RegExps for strings
    : T extends (infer U)[]
  ...
  > = {
    [key in keyof TSchema]?: [Extract<TSchema[key], FieldType>] extends [never]
      ? never
      : AssignableType;
  };
  ...
  export type UpdateQuery<T> = _UpdateQuery<_UpdateQueryDef<T>> &
    MatchKeysAndValues<_UpdateQueryDef<LeanDocument<T>>>;
